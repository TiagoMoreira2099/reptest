      ...
      if ($this->getSource() != NULL) {
        ...
        if ($hascoType == VSTOI::DETECTOR) {
          ...
          if ($this->getElement() != NULL &&
              isset($this->getElement()->wasGeneratedBy) &&
              $this->getElement()->wasGeneratedBy != NULL) {
            $wasGeneratedBy = $this->getElement()->wasGeneratedBy;
          }
          $form['element_source'] = [
            '#type' => 'item',
            '#title' => t('<b>Generated by</b>: [' . $wasGeneratedBy . ']'),
          ];
        }
      }
